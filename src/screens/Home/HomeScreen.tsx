...
const styles = StyleSheet.create({
  ...
  heroTitle: { color: '#fff7f1', fontSize: 28, fontWeight: '800', marginTop: 6 },
  heroSubtitle: { color: '#fff7f1', opacity: 0.9, marginTop: 6, lineHeight: 20 },
  ...
  statValue: { color: '#fff7f1', fontSize: 22, fontWeight: '800' },
  statLabel: { color: '#fff7f1', marginTop: 4, fontWeight: '700', fontSize: 12 },
